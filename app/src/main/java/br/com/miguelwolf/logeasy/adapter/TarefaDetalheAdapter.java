...
public class TarefaDetalheAdapter extends RecyclerView.Adapter<TarefaDetalheAdapter.MyViewHolder> {
    ...
    public TarefaDetalheAdapter(Context c, List<Pesquisa> l) {
        context = c;
        mList = l;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = mLayoutInflater.inflate(R.layout.item_tarefa_detalhe, parent, false);
