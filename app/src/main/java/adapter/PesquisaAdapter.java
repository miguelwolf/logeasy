...
public class PesquisaAdapter extends RecyclerView.Adapter<PesquisaAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(View itemView) {
            ...
            ivUsuario = itemView.findViewById(R.id.item_ivUsuario);
            tvNome = itemView.findViewById(R.id.item_tvNome);
            tvDescricao = itemView.findViewById(R.id.item_tvDescricao);
